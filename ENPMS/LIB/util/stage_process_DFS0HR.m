function stage_process_DFS0HR(INI)
...
for i = 1:n
   ...
   FILE_NAME = [INI.DIR_STAGE_DFS0HR,B,'.dfs0'];
   DFS0.STATION = B;
   ...
   % generate Cumulative    % Cumulative values are not relevant to 'water level' data sets - skipped.
   try
...
FID = fopen(INI.STAGEHR_LATEX_FILENAME,'w');

latex_print_begin(FID,INI.STAGEHR_LATEX_HEADER);
...
for i = 1:num_pngs
   ...
   latex_print_pages_figures(m,n,FID,INI.STAGEHR_LATEX_RELATIVE_PNG_PATH,NAME,strtrim(EXT),noFIG);
