function [DRED] = get_ave_HR_NONEQDIST_DD(date_v,x,R)
...
n = length(DD_ARRAY);
DRED.DD_WAVE(1:n) = NaN; % annual weighted average
DRED.DD_AVE(1:n) = NaN; % annual  average
DRED.DD_WSUM(1:n) = NaN; % annual weighted sumation
DRED.DD_SUM(1:n) = NaN; % annual  sumation
