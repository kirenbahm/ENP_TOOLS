...
NET.addAssembly('C:\Program Files (x86)\DHI\MIKE Core SDK\2022\bin\x64\DHI.Generic.MikeZero.DFS.dll');
NET.addAssembly('C:\Program Files (x86)\DHI\MIKE Core SDK\2022\bin\x64\DHI.Generic.MikeZero.EUM.dll');
