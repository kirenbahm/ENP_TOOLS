...
%%%%%%%%%%% initialize names%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%location of scripts
addpath(genpath('G:\ENP_2018\MODELS_20180101\01M06CAL\ENP_TOOLS\ENPMS'));

INI.MODEL = 'M01';
INI.MODEL = 'M06';

%name of excel file to be used
INI.XLSX_STATIONS = './OBSERVED_DATA_MODEL_07212018.xlsx';
INI.SHEET_ALL = ['SHP' '_' 'ALL_STATIONS'];
INI.SHEET_OBS = [INI.MODEL '_' 'MODEL_OBS'];
INI.SHEET_COMP = [INI.MODEL '_' 'MODEL_COMP'];

%name of database to be created
DATABASE_OBS = ['./' INI.MODEL '_OBSERVED_DATA_07212018.MATLAB'];
...
for i = 1:n
    try
        s = LISTING(i);
        FILENAME = s.name;
        FILEPATH = [INI.CURRENT_PATH DIR '/' FILENAME];
