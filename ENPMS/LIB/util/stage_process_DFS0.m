function stage_process_DFS0(INI)
...
FID = fopen(INI.STAGE_LATEX_FILENAME,'w');

latex_print_begin(FID,INI.STAGE_LATEX_HEADER);
...
for i = 1:num_pngs
   ...
   latex_print_pages_figures(m,n,FID,INI.STAGE_LATEX_RELATIVE_PNG_PATH,NAME,strtrim(EXT),noFIG);
