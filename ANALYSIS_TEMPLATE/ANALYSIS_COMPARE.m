...
%---------------------------------------------------------------------
i = i + 1;  INI.MODEL_SIMULATION_SET{i} = {INI.DATA_COMPUTED, 'M06_V01xx_00WM_CAL', 'CAL'};
i = i + 1;  INI.MODEL_SIMULATION_SET{i} = {INI.DATA_COMPUTED, 'M06_V0102_00WM_000_CAL', 'CAL3'};
% 
%---------------------------------------------------------------------
...
% INI.SELECTED_STATION_FILE = [INI.POST_PROC_DIR '/ENP_S335.txt']; 
