function DFS0_process_H_file_list_HR(INI)
...
latex_6_plot(INI.DIR_STAGE_PNGSHR,INI.STAGEHR_LATEX_FILENAME,INI.STAGEHR_LATEX_HEADER,INI.STAGEHR_LATEX_RELATIVE_PNG_PATH)
